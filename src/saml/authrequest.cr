...
module Saml
  ...
  class Authrequest < SamlMessage
    ...
    def create_params(settings, params = {} of String => String)
      ...
      request = create_authentication_xml_doc(settings).to_s
      # TODO: FIX request_doc.context[:attribute_quote] = :quote if settings.double_quote_xml_attribute_values

      Log.debug {"Created AuthnRequest: #{request}"}
